                ...
                <div className="hidden md:flex items-center gap-3">
                    {isAuthenticated && user ? (
                        <>
                            ...
                            <Button onClick={logout} className="bg-blue-600 hover:bg-blue-700 text-white shadow-md shadow-blue-600/20">
                                Log Out
                            </Button>
                        </>
                    ) : (
            ...
            {mobileMenuOpen && (
                <div className="md:hidden border-t border-slate-200 bg-white p-4 space-y-2">
                    ...
                    <div className="pt-4 space-y-2 border-t border-slate-100 mt-4">
                        {isAuthenticated && user ? (
                            <>
                                <Link href={getDashboardPath(user.role)} className="block">
                                    <Button variant="outline" className="w-full">Dashboard</Button>
                                </Link>
                                <Button onClick={logout} className="w-full bg-blue-600 hover:bg-blue-700 text-white">Log Out</Button>
                            </>
                        ) : (
                            <>
