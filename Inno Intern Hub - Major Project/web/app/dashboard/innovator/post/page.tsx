...
function PostProjectPage() {
    ...
    const handleSubmit = async (publish: boolean) => {
        ...
        try {
            ...
            alert("Failed to create project. Please verify that the title is at least 5 chars and description at least 50 chars.");
        } finally {
...
export default withAuth(PostProjectPage, ["INNOVATOR"]);
